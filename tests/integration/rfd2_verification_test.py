...
''')
        ...
        test_claims = [
            ...
            ("Added async version of simple_function", False),  # simple_function is not async
            ("Created function _private_function", True),  # Should find private functions
            ("Implemented async method async_method", True),  # Should find async methods
        ]
...
'''
        ...
        complex_claims = [
            ...
            ("Implemented Product model with database connection", False),  # No DB connection
        ]
...
''')
    ...
    def test_performance_and_edge_cases(self):
        ...
        edge_cases = [
            ...
            ("I think I maybe possibly created a function", False),  # Uncertain language
            ("# TODO: Create function foo", False),  # Comment, not actual creation
            ("def foo(): pass", False),  # Code snippet without context
            ("Created function with special characters: func_name_123", False),  # No such function
        ]
    ...
    def run_all_tests(self):
        ...
        tests = [
            ("Function Detection Comprehensive", self.test_function_detection_comprehensive),
            ("Modification Lie Detection Advanced", self.test_modification_lie_detection_advanced),
